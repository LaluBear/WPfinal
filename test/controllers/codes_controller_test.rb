...
class CodesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create code" do
    assert_difference('Code.count') do
      post codes_url, params: { code: { creditAmount: @code.creditAmount, status: @code.status, type: @code.type } }
    end
  ...
  test "should update code" do
    patch code_url(@code), params: { code: { creditAmount: @code.creditAmount, status: @code.status, type: @code.type } }
