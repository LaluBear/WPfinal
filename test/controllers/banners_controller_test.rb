...
class BannersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create banner" do
    assert_difference('Banner.count') do
      post banners_url, params: { banner: { bannerEndDate: @banner.bannerEndDate, bannerName: @banner.bannerName, bannerStartDate: @banner.bannerStartDate } }
    end
  ...
  test "should update banner" do
    patch banner_url(@banner), params: { banner: { bannerEndDate: @banner.bannerEndDate, bannerName: @banner.bannerName, bannerStartDate: @banner.bannerStartDate } }
